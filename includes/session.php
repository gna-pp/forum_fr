...
class session
{
	...
	*/
	function session_begin($update_session_page = true)
	{
		...
		// FLCT - 31/08/2012 - Affiche l'adresse ip distante avec un reverse proxy
		// https://redmine.partipirate.org/issues/492
		// === Code original
...
//		$db->sql_return_on_error(false);
		...
		{
			if ($config['shout_enable_robot'] && $config['shout_enable'] && function_exists('post_session_shout'))
			{
