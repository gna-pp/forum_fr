...
function generate_board_url($without_script_path = false)
{
	...
	else
	{
		...
		$cookie_secure = (isset($_SERVER["HTTP_X_FORWARDED_SCHEME"]) && $_SERVER["HTTP_X_FORWARDED_SCHEME"] == "https") ? 1 : 0;
		$bXForward = isset($_SERVER["HTTP_X_FORWARDED_SCHEME"]);
	...
	if ($server_port && (($cookie_secure && $server_port <> 443 && !$bXForward) || (!$cookie_secure && $server_port <> 80)))
	{
...
function page_header($page_title = '', $display_online_list = true, $item_id = 0, $item = 'forum')
{
	...
	// lefty74 Announcement Centre - Fin

	// Send a proper content-language to the output
	$user_lang = $user->lang['USER_LANG'];
// --START "Thanks for post"  1.3.4
// 14.09.2012 FLCT

	$user->add_lang('mods/thanks_mod');

// --END "Thanks for post"  1.3.4
