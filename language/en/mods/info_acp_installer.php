...
$lang = array_merge($lang, array(
	...
	'INSTALL_INSTALLER'				=> 'Breizh Installer © 2010, 2011', // Title of the installer
	'INSTALL_WELCOME_TEXT'			=> 'Welcome to the installation of %s',
	'INSTALL_WELCOME_TITLE'			=> '%s&nbsp;&nbsp;Installation of Mod %s', // Allows to include a picture
	'INSTALL_PAGE_TITLE'			=> 'Installation of Mod %s',
	'INSTALL_ETAT'					=> 'Installation Status:',
	'INSTALL_ETAT_INFO'				=> '<strong>Explanations</strong>: %s <span style="color:red;">Operations remaining to be done</span>&nbsp;&nbsp;-&nbsp;&nbsp;%s <span style="color:green;">Operations completed</span>',
	...
	'INSTALL_METHOD_ALL'			=> 'Installation with all the details',
	'INSTALL_METHOD_FAST'			=> 'Quick installation with no details',
	'INSTALL_GO'					=> 'Send',
	...
	'INSTALL_NO_PATH'				=> 'The folder <b>“ %s ”</b> is absent.<br />',
	'INSTALL_NO_FILE'				=> 'The file <b>“ %s ”</b> is absent.<br />',
	...
	'INSTALL_FINISH_MESSAGE'		=> '► Warning, if you need troubleshooting or information, visit <a href="http://breizh-portal.com/index.html" title="Breizh Portal - The Breizh Touch">Breizh Portal</a>. The support will be provided <strong>exclusively</strong> on this site.<br />Also find our other exclusive Mods.
										<br />Consider making a donation to the continuity of support and development, thank you.<br /><br />► To complete the installation and for safety reasons, you <strong>must</strong> delete or rename the install/ folder from your server via FTP.<br />',
	'INSTALL_PROGRESS'				=> 'The script is currently executing the action requested...',
	'INSTALL_TABLE_UNDEFINED'		=> 'Error: The table “<strong>%s</strong>” is not defined in the file includes/constant.php<br /><br />Please review <strong>all</strong> the instructions in the file install.xml<br />',
	...
	'LOG_INSTALL_AUTH_DEL_ALL'		=> '<strong>Removing permissions of a mod</strong><br />» “%s” mod “%s”',
	...
	'LOG_INSTALL_COLUMN_ADD'		=> '<strong>Adding a column in a table</strong> » %1$s dans %2$s',
	'LOG_INSTALL_COLUMN_DEL'		=> '<strong>Deleting a column in a table</strong> » %1$s dans %2$s',
	'LOG_INSTALL_COLUMN_EDIT'		=> '<strong>Modifying a column in a table</strong> » %1$s dans %2$s',
