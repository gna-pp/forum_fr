...
//-- begin mod: phpBB Code Repository --
	'VIEW_CODE_REPO'			=> 'Code Repository',
	'VIEW_CODE_REPO_MORE'			=> 'Voir Code Repository',
	'VIEWING_CODE_REPO'			=> 'Consulter le Code Repository',
//-- end mod: phpBB Code Repository --	
	...
	'LOGIN_ERROR_PASSWORD'				=> 'Vous avez spécifié un mot de passe incorrect.<br/> Veuillez vérifier votre mot de passe <u>en faisant attention aux majuscules</u>  et réessayer. Veuillez contacter l’%sadministrateur du forum%s si ce problème persiste.',
	...
	'LOGIN_ERROR_USERNAME'				=> 'Vous avez spécifié un nom d’utilisateur incorrect.<br/> Veuillez vérifier votre nom d’utilisateur <u>en faisant attention aux majuscules</u> et réessayer. Veuillez contacter l’%sadministrateur du forum%s si ce problème persiste.',
	...
	// FLCT - 28/08/2012 Ticket 487 https://redmine.partipirate.org/issues/487
	// === Code original
	//'SORRY_AUTH_READ'			=> 'Vous n’êtes pas autorisé à consulter ce forum.',
	// === code modifié => END
	'SORRY_AUTH_READ'			=>  "Il semblerait que vous n'ayez pas accès à ce forum. <br/>".
									"Il est possible que seuls les adhérents du Parti Pirate puissent avoir accès à ce forum. <br/>".
									"Si vous êtes adhérents et que vous n'y avez pas accès,  ".
									"lisez le chapitre \"La section du forum réservée aux adhérents\" sur <a href=\"https://www.partipirate.org/spip.php?article119\">cette page</a> pour l'obtenir.  <br/>",
	// === END
...
$lang = array_merge($lang, array(
	...
	'REVU_PRESSE'		=> 'Revue de presse',
	'PLANETE_PP'		=> 'Planète pirate',
	'AGENDA'			=> 'Agenda',

	'NOUS'				=> 'Qui sommes-nous ?',
	'PRESENTATION'		=> 'Présentation',
	'PROGRAMME'			=> 'Notre programme',
	'AUTRES_IDEES'		=> 'Autres idées...',
	'LEGIS2012'			=> 'Législatives 2012',
	'PETITIONS'			=> 'Pétitions',

	'ADHEREZ'			=> 'Adhérez',
	'DEVENIR_PP'		=> 'Devenir pirate !',
	'DON'				=> 'Faire un don',

	'PARTICIPEZ'		=> 'Participez !',
	'WIKI'				=> 'Wiki',
	'FORUM'				=> 'Forums',
	'LIQD_FEED'			=> 'liquid feedback',
	'LISTE_DIFF'		=> 'Listes de diffusion',
	'IRC'				=> 'Chat IRC en direct',
	'CONTRIB_SITE'		=> 'Contribuez à la vie de ce site',

	'SL'				=> 'Sections locales',
	'FINANCE_SL'		=> 'Financement des Sections Locales',
	'COORD'				=> 'Coordinateurs et autres responsables par section',
	'PP_AL'				=> 'Parti Pirate Alsace',
	'PP_AQ'				=> 'Parti Pirate Aquitaine',
	'PP_BZH'			=> 'Parti Pirate Bretagne',
	'PP_FC'				=> 'Parti Pirate Franche-Comté',
	'PP_IDF'			=> 'Parti Pirate Île-de-France',
	'PP_RE'				=> 'Parti Pirate La Réunion',
	'PP_MP'				=> 'Parti Pirate Midi-Pyrénées',
	'PP_NPDC'			=> 'Parti Pirate Nord-Pas de Calais',
	'PP_PACA'			=> 'Parti Pirate PACA',
	'PP_PC'				=> 'Parti Pirate Poitou-Charentes',
	'PP_RA'				=> 'Parti Pirate Rhône-Alpes',
	'LISTE_REGION'		=> 'Listes de discussion par région',

	'CREA'				=> 'Créations',
	'AFFICHES'			=> 'Affiches et bannières',
	'BOUTIQUE'			=> 'La boutique',
	'COMPIL1'			=> 'La compil\’ pirate Vol.1',
	'COMPIL2'			=> 'La compil\’ pirate Vol.2',
	'RADIO'				=> 'Radio Pirate',

	'CONTACTS'			=> 'Contacts',
	'CONTACT_SITE'		=> 'L’équipe du site',
	'CONTACT_SL'		=> 'Sections locales',
	'RESPONSABLES'		=> 'Les responsables',
	'CHARGE_MISSION'	=> 'Chargés de mission',

	'URLPP'				=> '//www.partipirate.org',
	'URLWIKI'			=> '//wiki.partipirate.org',
	'URLFORUM'			=> '//forum.partipirate.org',
	'URLLIQDEM'			=> '//liqdem.partipirate.org:1337/',
	'URLLISTS'			=> '//lists.partipirate.org/',
	'URLPP_BOUTIQUE'	=> '//boutique.partipirate.org/',
	'URLPP_AL'			=> '//alsace.partipirate.org/',
	'URLPP_AQ'			=> '//www.facebook.com/PartiPirateAquitaine',
	'URLPP_BZH'			=> '//bretagne.partipirate.org/',
	'URLPP_FC'			=> '//www.partipirate.org/spip.php?article169', // A modifier
	'URLPP_IDF'			=> '//idf.partipirate.org/',
	'URLPP_RE'			=> '//partipirate.re/',
	'URLPP_NPDC'		=> '//npdc.partipirate.org/',
	'URLPP_PACA'		=> '//paca.partipirate.org ', 
	'URLPP_MP'			=> '//midi-pyrenees.partipirate.org/',
	'URLPP_PC'			=> '//poitou-charentes.partipirate.org/',
	'URLPP_RA'			=> '//rhone-alpes.partipirate.org/'

));
// Fin ajouts

$lang = array_merge($lang, array(
	'CHARTE_FOFO'            => 'Charte des forums du Parti Pirate',	
	'MODE_EMPLOI'            => 'Parti Pirate - Mode d\'emploi',	
	'COMPTE_PP'            => 'Les comptes du Parti Pirate',		
	
	'MCHARTE_FOFO'            => 'Charte',	
	'MMODE_EMPLOI'            => 'Mode d\'emploi',	
	'MCOMPTE_PP'            => 'Nos comptes',	
));

$lang = array_merge($lang, array(
	'POSTES_CA'            => 'Candidats au Conseil d\'Adminstration du Parti Pirate',	
	'POSTES_CN'            => 'Candidats au Conseil National du Parti Pirate',		
	'DOCUMENTS_AG'            => 'Documents en téléchargements',	
	'STATUTS_AG'            => 'Statuts',	
	'RI_AG'            => 'Réglement Intérieur',			
	'BULLETIN_AG'            => 'Bulletin de vote',					
	
	'FICHIER_PDF'            => 'Télécharger (pdf)',					
	'FICHIER_ODT'            => 'Télécharger (odt)',					
	
	'PROFESSION_FOI'            => 'Profession de foi',	
	'NO_PROFESSION_FOI'            => 'Non transmise',		
	'OMBRE'            => 'Ombre',			
	'OMBRE_NOM'            => 'Thibault Lesage',		
	'RAPH'            => 'Raphaël Flores',			
	'RAPH_NOM'            => 'Raphaël Flores',		
	'PAUL'            => 'Paul',			
	'PAUL_NOM'            => 'Paul Da Silva',		
	'KARIMA'            => 'AgentK',			
	'KARIMA_NOM'            => 'Karima Rafes',		
	'TORNADE'            => 'Tornade',			
	'TORNADE_NOM'            => 'Karine C',		
	'HARPALOS'            => 'Harpalos',			
	'HARPALOS_NOM'            => '-',		
	'QQDQQ'            => 'Cry-stof',			
	'QQDQQ_NOM'            => 'Christophe Palisser',		
	'JANCRY'            => 'Jancry',			
	'JANCRY_NOM'            => 'Jean Christophe Frachet',		
	'SIMS'            => 'Sims',			
	'SIMS_NOM'            => 'Simon Schmitt',		
	'KO'            => 'Ko',			
	'KO_NOM'            => 'Kévin Beaubestre',												
	'MAXROU'            => 'Marou',			
	'MAXROU_NOM'            => 'Maxime Rouquet',													
	'PEER'            => 'Peer@',			
	'PEER_NOM'            => 'Fabien Karp',	
	'CANDIDAT'            => 'Candidat',		
	'NO_VOTE'            => 'Election non réalisée',				
	'VOTE_OK'            => 'Elu',					
	'VOTE_NO'            => 'Non élu',					
