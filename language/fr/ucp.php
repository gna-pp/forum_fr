...
<b>Charte modération</b>
<br /><br />
Tous les membres du forum s\'engagent par leur inscription à suivre la présente charte.
Ce forum a pour but l\'expression aussi libre que possible de ses membres sur le “%1$s”, et tous les sujets sur lesquels le Parti Pirate est partie prenante, intervient ou devrait intervenir.
<br /><br />
<b>Avant de poster :</b>
<br /><br />
Passez dans le forum d\'Accueil pour vous présenter.
<br /><br />
Tout message posté sur le forum n\'engage que la responsabilité de son auteur. Il n\'engage pas la responsabilité de l\'équipe d\'administration et de modération du forum, ou du “%1$s”, et ne reflète en aucun cas les opinions du “%1$s” et des administrateurs du site.
<br /><br />
En cas de non respect de cette charte et des lois et réglementations en vigueur en France, l’auteur s’expose, au delà du simple retrait de son message sur ce forum, aux sanctions civiles ou pénales afférentes.
<br /><br />
Les messages sur le forum se doivent d\'être courtois et de suivre les principes de la netiquette. D\'ailleurs, il est formellement autorisé de dire "bonjour", "merci", d\'utiliser les smileys et même d\'avoir de l\'humour.
<br /><br />
Si possible, et pour la compréhension de tous, essayez si possible de poster dans un français aussi correct que possible et d\'éviter le SMS, exception faite en particulier du sous-forum international où des amis étrangers s\'expriment. Utilisez les correcteurs d\'orthographe de votre OS s\'il en dispose d\'un et relisez-vous. Ceci écrit, il n\'y a pas de tribunal de l\'orthographe et la tolérance est de mise. L\'important est que tout membre puisse s\'exprimer selon ses capacités et ceci prime sur ce qui précède.
<br /><br />
Les acronymes usuels sont autorisés. Si vous n\'en comprenez pas un, la wikipedia, le wiktionnaire et les moteurs de recherche sont vos amis. (Si un membre veut lister les acronymes usuels utilisés en forum, qu\'il se dénonce.)
<br /><br />
N\'ÉCRIVEZ PAS AUTANT QUE POSSIBLE EN LETTRES CAPITALES, respectez les oreilles des autres membres. Ils ne sont pas ENCORE sourds (quoique…)
<br /><br />
Essayez de mettre un titre clair si vous ouvrez une discussion.
<br /><br />
Les fils de discussion en doublon sont supprimés sans préavis.
<br /><br />
Le hors-sujet (OT) est à éviter et pourra être supprimé.
<br /><br />
Le forum est public et indexé sur les moteurs de recherche. Si vous ne désirez pas qu\'une information soit publique, ne la postez pas.
<br /><br />
Les messages et les avatars ne doivent pas contrevenir au droit des auteurs. Le droit de citation implique qu\'une œuvre de l\'esprit ne peut être citée in extenso, l\'auteur et la source doivent être nommés, et si disponible adjoindre un lien vers la source. Tout matériel posté sous licence libre doit préciser la licence concernée et ses dépendances.
<br /><br />
De même, tout matériel cité à l\'extérieur du site qui a pour origine le forum devra respecter les règles de citation (auteur, URL précise)
<br /><br />
Sont strictement interdits dans le forum :
<br />
- le spam
<br />
- les coordonnées personnelles (nom, adresse postale, téléphone, emails de tiers)
<br />
- les adresses emails en clair
<br />
- les menaces
<br />
- les insultes et propos injurieux, ad hominem ou pas.
<br />
- la diffamation (atteinte à l\'honneur)
<br />
- les propos attentatoires à la vie privée, au secret médical, au secret professionnel, à la sécurité des personnes et des biens.
<br />
- l\'atteinte au droit à l\'image
<br />
- l\'apologie de crimes et délits
<br />
- et en particulier tout propos racistes, les apologies de crime de guerre, de crime contre l\'humanité, le négationnisme, le révisionnisme.
<br />
(Par application du droit français, n\'oubliez pas que vous en serez légalement responsables.)
<br /><br />
Tout fil qui devient une réserve naturelle incendiaire et poilue de trolls sera fermé et estampillé comme tel. Cette fermeture sera d\'une durée de 3 à 7 jours. Le fil sera fermé définitivement si le fil repart en trollerie sauvage. Seuls les modérateurs peuvent dans ce cas ouvrir un fil parallèle pour réorienter la discussion.
<br /><br />
<b>Administration</b>
<br /><br />
Le forum est sous la garde d\'une part de l\'administrateur qui gère les aspects techniques et de l\'équipe de modération qui veille à à la bonne marche des forums selon la présente charte.
<br /><br />
En cas de problème technique, commencer par signaler le problème en forum par le biais des liens de signalement, puis, si l\'intervention des modérateurs ne résout pas le problème, contacter l\'administrateur, qui peut être joint par mail là : technique@partipirate.org
<br /><br />
<b>Modération</b>
<br /><br />
La modération s\'exerce à postériori.
<br /><br />
Les modérateurs ont le droit de déplacer, modifier, supprimer les titres et les messages postés s\'il contreviennent à la charte ou s\'ils sont mal placés. Les modérateurs peuvent fermer un sujet de même. Les modérateurs se doivent d\'être neutre et ne sont en aucun cas des censeurs, mais ils appliquent la charte aussi bien que possible ou s\'en inspirent pour préserver le calme et des échanges aussi fructueux que possible.
<br /><br />
Le non respect, répété, des décisions de modération entrainera le bannissement du forum.
<br /><br />
Les modérateurs sont responsables de la bonne tenue des forums sous la supervision du modérateur général. Leurs décisions sont, sauf urgence, collégiales. Leurs décisions sont prises selon la charte et motivées en privé à postériori. Les décisions ne sont contestables qu\'auprès du modérateur général et toujours en privé.
<br /><br />
Pour les cas non prévus par la présente charte et qui nécessitent une intervention, le collège des modérateurs statue après décision provisoire du modérateur général. Le collège peut demander l\'avis du CA du “%1$s” pour prendre une décision.
<br /><br />
Les membres peuvent proposer toutes modifications et améliorations de la Charte qu\'ils estiment utiles. La présente charte est modifiable sans préavis sur décision du collège de modération et de l\'administrateur après avis du CA du “%1$s”.
<br /><br />
<b>Sanctions</b>
<br /><br />
Les sanctions possibles sont :
<br />
- la modification ou la suppression totale ou partielle d\'un titre ou d\'un message.
<br />
- Le signalement du fil de discussion comme "appeau à troll".
<br />
- La suppression des droits de publication pendant une semaine.
<br />
- Le bannissement momentané de 3 jours, un mois, ou définitif.
<br />
- L\'effacement du compte.
<br /><br />
<b>Informatique et liberté, données personnelles :</b>
<br /><br />
...
<br /><br />
Vous pouvez à tout moment nous demander la modification ou la suppression de vos propres messages à [adresse], en prenant soin de nous indiquer les éléments suivants : titre et date de publication du message, pseudo utilisé et URL. Utilisez à cet effet préférentiellement la messagerie interne du forum.
<br /><br />
Conformément aux dispositions de la loi Informatique et Libertés du 6 janvier 1978 modifiée par la Loi du 6 août 2004, toutes les données informatiques vous concernant sont traitées de maniére confidentielle. Vous disposez d\'un droit d\'accès, de rectification, et d\'opposition sur vos données. Pour cela il vous suffit de nous en faire la demande par courrier électronique (contact_at_partipirate_dot_org) en nous indiquant vos nom, prénom, adresse.	',
